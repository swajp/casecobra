...
export default function UploadPage() {
  ...
  return (
    <div
      className={cn(
        "relative h-full flex-1 my-16 w-full bg-gray-900/5 rounded-xl p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center",
        {
